...
///
- (nullable instancetype)initWithDidRequestToOpenURLBlock:(void (^ _Nonnull)(KVAConsentDialogNavigationController * _Nonnull, NSURL * _Nonnull))didRequestToOpenURLBlock didCompleteBlock:(void (^ _Nonnull)(KVAConsentDialogNavigationController * _Nonnull))didCompleteBlock;
...
/// \param didCompleteBlock A block which is called when the navigation controller’s lifecycle did complete.  Set this value to dismiss the view controller.
///
+ (nullable instancetype)consentDialogNavigationControllerWithDidRequestToOpenURLBlock:(void (^ _Nonnull)(KVAConsentDialogNavigationController * _Nonnull, NSURL * _Nonnull))didRequestToOpenURLBlock didCompleteBlock:(void (^ _Nonnull)(KVAConsentDialogNavigationController * _Nonnull))didCompleteBlock SWIFT_WARN_UNUSED_RESULT;
...
/// Create an instance of KVAConsentDialogViewController.
/// \param didRequestToOpenURLBlock A closure which is called when an event occurs which requests to open a url.  Set this value to open the specified url.
///
/// \param didCompleteBlock A closure which is called when the view controller’s lifecycle did complete.  Set this value to dismiss the view controller.
///
- (nullable instancetype)initWithDidRequestToOpenURLBlock:(void (^ _Nonnull)(KVAConsentDialogViewController * _Nonnull, NSURL * _Nonnull))didRequestToOpenURLBlock didCompleteBlock:(void (^ _Nonnull)(KVAConsentDialogViewController * _Nonnull))didCompleteBlock OBJC_DESIGNATED_INITIALIZER;
